...
<!-- ═══ MANUTENÇÃO ═══ -->
<div class="sec" style="margin-top:6px;background-color: #bfcf99">MANUTENÇÃO;border: 1px solid #bbb</div>
<table style="margin-bottom:0">
  <thead>
    ...
    <tr>
      ...
      ${VTH_MAN('Status FORM 012','background: #566E3D','color:#fff')}
      ${VTH_MAN('Data da aprovação','background: #566E3D','color:#fff')}
      ...
      ${VTH_MAN('Análise Crítica','background: #566E3D','color:#fff')}
